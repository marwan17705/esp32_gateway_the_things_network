...
uint8_t debug=2;											// Debug level! 0 is no msgs, 1 normal, 2 extensive
...
#		endif //_MONITOR
		...
		msg_oLED("FORMAT");Serial.println("FORMAT");
		SPIFFS.format();
		delay(500);
...
#	if _SPIFFS_FORMAT>=1
	msg_oLED("FORMAT");Serial.println("FORMAT");Serial.println("FORMAT");
...
//Serial.print("SCK:"+(char*)SCK+"MISO:"+char*)MISO+"MOSI:"+MOSI+"SS:"+SS+"\n");
#else
	SPI.begin();
#endif //ESP32_ARCH
